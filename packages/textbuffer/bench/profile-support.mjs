...
const STRUCTURAL_COUNTER =
  /cloneNode\.calls|createNode\.calls|tree\.own\.calls|cloneReverseIndexNode\.calls|createReverseIndexNode\.calls|ownReverseIndexNode\.calls|replacementRecords|copiedArraySlots|indexInputCodeUnits|typedArrayCapacityBytes|typedArrayCopiedBytes|normalizePieceOrders\.calls|tryCoalesceInsert\.calls|extendTailChunk\.calls|splitsSurrogatePair\.calls|readPieceTableTextRange\.calls|collectTextInRange\.calls|priorityForPiece\.calls|mixString\.calls|snapBatchEditRanges\.calls|snapEditRange\.calls|lineStartOffset\.calls|PieceBufferChunkView\.(?:fork|fill|open)\.calls|getPositionAt\.calls|getOffsetAt\.calls|getLineContent\.calls|cachedLineHits|TreeNode\.constructor\.calls|leftRotate\.calls|rightRotate\.calls|createLineStarts.*loopIterations|countLineBreaks\.loopIterations|extendBufferLineIndex\.loopIterations/
