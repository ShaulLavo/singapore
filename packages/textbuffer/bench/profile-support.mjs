...
const STRUCTURAL_COUNTER =
  /cloneNode\.calls|createNode\.calls|cloneReverseIndexNode\.calls|createReverseIndexNode\.calls|replacementRecords|copiedArraySlots|indexInputCodeUnits|typedArrayCapacityBytes|typedArrayCopiedBytes|normalizePieceOrders\.calls|tryCoalesceInsert\.calls|extendTailChunk\.calls|splitsSurrogatePair\.calls|readPieceTableTextRange\.calls|collectTextInRange\.calls|sharesIndexedPrefix\.calls|prefixCompares|prefixCompareCodeUnits|priorityForPiece\.calls|mixString\.calls|snapBatchEditRanges\.calls|snapEditRange\.calls|lineStartOffset\.calls|retainedHits|getPositionAt\.calls|getOffsetAt\.calls|getLineContent\.calls|cachedLineHits|TreeNode\.constructor\.calls|leftRotate\.calls|rightRotate\.calls|createLineStarts.*loopIterations|countLineBreaks\.loopIterations|extendBufferLineIndex\.loopIterations/
