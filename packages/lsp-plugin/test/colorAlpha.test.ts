...
describe('registered diagnostic opacity color', () => {
  it.each([
    ['#000a', 170 / 255], ['#0007', 119 / 255], ['#ffcc0010', 16 / 255],
    ['rgba(10, 20, 30, 0.25)', 0.25], ['rgb(10 20 30 / 40%)', 0.4],
    ['color(srgb 0.1 0.2 0.3 / 0.75)', 0.75], ['oklch(50% 0.2 30 / 0)', 0],
    ['rgb(10, 20, 30)', 1], ['transparent', 0],
