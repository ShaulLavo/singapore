...
describe('default editor keybindings', () => {
  ...
  it.each([
    ...
    ['windows', 'cursorColumnSelectLeft', { alt: true, key: 'Home', mod: true, shift: true }],
    ['windows', 'cursorColumnSelectRight', { alt: true, key: 'End', mod: true, shift: true }],
    ...
    ['linux', 'cursorColumnSelectLeft', { alt: true, key: 'Home', mod: true, shift: true }],
    ['linux', 'cursorColumnSelectRight', { alt: true, key: 'End', mod: true, shift: true }],
