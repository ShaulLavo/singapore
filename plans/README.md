...
E036–E040 were added on 2026-09-14 and 2026-09-16, and E037 and E038 completed on 2026-09-16, so
10 completed entries retain permanent references and 31 execution plans remain, E041 among
them, added on 2026-09-16.
...
| Textbuffer cost             | [E041 transient edits](e041-transient-edits.md), the research that decides how E039 and E040 are shaped, on top of completed [E037](../docs/performance/e037-textbuffer-edit-allocations.md) and [E038](../docs/performance/e038-append-only-buffer-store.md) | E040 balanced tree and E039 reverse index follow, rebased on E041's decision.                                               |
...
remaining entries each change one structure and are measured against that gate. E041 decides,
before E039 and E040 are built, how much of the gap is persistence at all.
...
| [E041 — Measure whether in-place edits between retained snapshots close the small-edit gap](e041-transient-edits.md)        | Research       | Editor | P1       | M    | [E037](../docs/performance/e037-textbuffer-edit-allocations.md), [E038](../docs/performance/e038-append-only-buffer-store.md) |
