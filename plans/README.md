...
40 stable entries cover all 23 topics in the original [wishlist](../TODO.md).
...
There are **33 Editor-owned entries, 6 requiring both repositories, and 1 Platform-owned entry**.
By deliverable, there are **27 implementation entries, 11 research entries, and 2 design entries**.
...
27 execution plans remain. None of those remaining plans was classified as almost complete by
...
| Textbuffer cost             | [E037 per-edit allocations](e037-textbuffer-edit-allocations.md), which also makes the benchmark counters a gate                                                                                                                                          | E038 buffer store and E040 balanced tree can run in parallel; E039 reverse index follows E038.                              |
...
E037 lands first and turns the structural counters into a CI gate; the three larger entries each
change one structure and are measured against that gate.

| Plan                                                                                                    | Kind           | Owner  | Priority | Size | Needs                                                                                 |
| ------------------------------------------------------------------------------------------------------- | -------------- | ------ | -------- | ---- | ------------------------------------------------------------------------------------- |
| [E037 — Remove avoidable per-edit allocations from the textbuffer](e037-textbuffer-edit-allocations.md) | Implementation | Editor | P1       | M    | —                                                                                     |
| [E038 — Append inserted text without copying the buffer store](e038-append-only-buffer-store.md)        | Implementation | Editor | P1       | L    | [E037](e037-textbuffer-edit-allocations.md)                                           |
| [E039 — Make reverse-index maintenance cheaper than the edit it follows](e039-reverse-index-cost.md)    | Implementation | Editor | P2       | L    | [E037](e037-textbuffer-edit-allocations.md), [E038](e038-append-only-buffer-store.md) |
| [E040 — Replace treap balancing with a join-based balanced tree](e040-balanced-persistent-tree.md)      | Implementation | Editor | P1       | L    | [E037](e037-textbuffer-edit-allocations.md)                                           |
