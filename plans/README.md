...
[E033](../docs/performance/e033-full-text-boundary.md) is complete on 2026-09-23: routine reads, updates and edits no longer flatten the document, and `check:full-text` gates the named exceptions. Its execution plan has been removed.
[E053](../docs/display/diagnostic-overlays.md) is complete on 2026-09-25: token-colored fade and strike overlays pass Chromium, Firefox and WebKit paint tests; both Platform scenarios pass Chromium and Firefox.
[E055](../docs/performance/e055-edit-commands-read-lines.md) is complete on 2026-09-25: edit, reindent, trim and occurrence commands read the rows, words and windows they touch, and the `commandDocumentText` exception E033 left is deleted. Its execution plan has been removed.
E030 moved to Platform Plan 168 on 2026-09-25, because all of its work is in Platform. Decided 2026-09-25: owner — Plan 168 is dropped: the file tree's search covers it. [Platform's PLAN.md](../../platform/PLAN.md) records the drop under Parked plans.
...
[E050](../docs/architecture/e050-host-obligations.md) is complete on 2026-09-25. All eleven audited
host obligations have public contracts and migrated callers, including theme colors and cancellable row handles.
[E020](../docs/editing/jump-history.md) is complete: meaningful same-document jumps survive edits,
with independent per-view trails, Find and pointer integration, and anchored viewport restoration.
...
references, E030 moved to Platform and E055 was added, and E055 completed the same day. Later the
same day the owner closed E010, E012 and E013 as no-go, folded E009 into Platform Plan 099 and
added E057, and E052 absorbed E022. Recounted from `backlog.json` on 2026-09-25 (an earlier count of 33 missed E020 and
E050): 39 entries are complete, 2 moved to Platform, and 14 execution plans remain.
...
- Decided 2026-09-25: owner — the SAB transport is the same speed as the string path after the
  transport fixes (the [2026-09-12 numbers](../docs/performance/sab-transport-2026-09-12.md) predate
  them) and never got faster, so it is deleted: [E057](e057-delete-sab-transport.md) is queued as a
  small task. E010, E012 and E013 are closed as no-go for that reason; their plans are in git
  history. E009 is folded into Platform [Plan 099](../../platform/plans/099-document-contributions.md)
  unit 6 and closed here.
- Decided 2026-09-25: owner — [E011](e011-packed-piece-tree.md) is parked under Platform Plan 112's
  large-file work, revived only if 112 shows piece memory dominates.
  [E016](e016-bounded-structural-parsing.md) is kept and moves under Plan 112 and E015.
- Decided 2026-09-25: owner — [E021](e021-styled-clipboard.md) steps 3–5 are kept, queued as future work.
- Decided 2026-09-25: owner — E022 (compact blank lines) folds into [E052](e052-proportional-font-extents.md), which
  absorbs it as shared variable row geometry. E022's plan text is kept whole inside E052; its ID
  leaves the inventory.
- Decided 2026-09-25: owner — [E023](e023-instrumentation-panel.md) is parked; [E024](e024-syntax-tree-inspector.md) is
  kept.
...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Performance foundation      | Completed [E006 reclamation](../docs/storage/e006-tombstone-compaction.md), E003 startup, E007 copies and E008 find, using the [E001 harness](../examples/stress/README.md)                                                                                                  | E014 parallel search builds on E008 and waits for Platform Plan 099. E009 is folded into 099 unit 6.                                                                                                                                     |
...
| Display and full-text reads | Completed [E007 consumer inventory](../docs/performance/e007-consumer-copies.md), building on completed [E031](../docs/performance/e031-projection.md), [E032](../docs/performance/e032-edit-batches.md), and [E034](../docs/performance/e034-snapshot-indentation-folds.md) | Completed [E033](../docs/performance/e033-full-text-boundary.md) closed the explicit full-text boundary.                                                                                                                                 |
| Everyday editing            | [E021 styled copy](e021-styled-clipboard.md): unit 1 is done, portable colors remain. Completed [E020 jump history](../docs/editing/jump-history.md) needs nothing more                                                                                                      | These are independently scoped Editor features; they need no shared-memory work.                                                                                                                                                         |
| History                     | Completed [E017 branching undo](../docs/editing/undo-graph.md)                                                                                                                                                                                                               | E019 viewer landed with it, and [E018 persisted history](../docs/editing/e018-persisted-undo.md) landed on 2026-09-20.                                                                                                                   |
| Developer tools             | [E024 syntax inspector](e024-syntax-tree-inspector.md)                                                                                                                                                                                                                       | [E023 timing panel](e023-instrumentation-panel.md) is parked (owner, 2026-09-25).                                                                                                                                                        |
...
| Large-file architecture     | [E057 SAB transport deletion](e057-delete-sab-transport.md), then Platform [Plan 112](../../platform/plans/112-large-file-ceiling.md)                                                                                                                                        | [E015](e015-massive-file-loading.md) after 112, with [E016](e016-bounded-structural-parsing.md) under them. [E011](e011-packed-piece-tree.md) revives only if 112 shows piece memory dominates. E010, E012 and E013 are closed as no-go. |
...
| Other independent work      | [E052 row geometry](e052-proportional-font-extents.md), which absorbed E022 compact rows                                                                                                                                                                                     | E030 is no longer an Editor starting point: it moved to Platform Plan 168, which the owner dropped on 2026-09-25.                                                                                                                        |
...
- Tree-sitter shared text is already decoded once and cached. The owner decided on 2026-09-25 to
  delete the SAB text transport (E057) and closed E010, E012 and E013 as no-go. Minimap range reads
  and incremental LSP sync exist.
...
- Undo already has a depth limit; branches need a retention policy. Cursor Undo/Redo also exists;
  E020 supplies an edit-surviving trail for meaningful jumps.
- Styled HTML copy includes multiple selections. E021 still owns portable colors.
- The virtualizer accepts variable row sizes, but text geometry still assumes a uniform stride.
  E052, which absorbed E022, must prove all caret, pointer, scroll, and selection mappings agree.
...
| [E055 — Edit commands read the lines they touch](../docs/performance/e055-edit-commands-read-lines.md)                       | Implementation | Editor | P1       | M    | [E033](../docs/performance/e033-full-text-boundary.md)                                                                                                                                                                |
| [E052 — Wrap and horizontal extent from measured advances when the font is not monospace](e052-proportional-font-extents.md) | Implementation | Editor | P3       | L    | [E036](../docs/display/e036-monaco-geometry-comparison.md), [E001](../examples/stress/README.md)                                                                                                                      |
...
| [E009 — Decide worker transport changes from measured costs](../../platform/plans/099-document-contributions.md)        | Research       | Cross-repo | P2       | M    | [E001](../examples/stress/README.md)                                                                                                                |
| [E010 — Prove a shared allocator and concurrent hash map](../docs/performance/sab-transport-2026-09-12.md)              | Research       | Editor     | P3       | L    | [E009](../../platform/plans/099-document-contributions.md)                                                                                          |
| [E011 — Evaluate a packed representation of persistent piece trees](e011-packed-piece-tree.md)                          | Research       | Editor     | P3       | L    | [E005](../docs/storage/piece-tree-inspection.md), [E009](../../platform/plans/099-document-contributions.md)                                        |
| [E012 — Reuse shared storage only after every reader releases it](../docs/performance/sab-transport-2026-09-12.md)      | Research       | Editor     | P3       | L    | [E006](../docs/storage/e006-tombstone-compaction.md), [E010](../docs/performance/sab-transport-2026-09-12.md), [E011](e011-packed-piece-tree.md)    |
| [E013 — Let eligible workers read shared immutable document snapshots](../docs/performance/sab-transport-2026-09-12.md) | Research       | Cross-repo | P3       | XL   | [E010](../docs/performance/sab-transport-2026-09-12.md), [E011](e011-packed-piece-tree.md), [E012](../docs/performance/sab-transport-2026-09-12.md) |
| [E057 — Delete the SAB text transport](e057-delete-sab-transport.md)                                                    | Implementation | Editor     | P2       | S    | —                                                                                                                                                   |
...
| [E020 — Navigate cursor jump history](../docs/editing/jump-history.md)                              | Implementation | Editor     | P2       | M    | —                                     |
...
| [E053 — Diagnostic tags paint in each token's own colour, in every engine](../docs/display/diagnostic-overlays.md)                             | Implementation | Editor | P2       | M    | —                                    |
...
| Plan                                                                                          | Kind           | Owner      | Priority | Size | Needs                                                                                                    |
| --------------------------------------------------------------------------------------------- | -------------- | ---------- | -------- | ---- | -------------------------------------------------------------------------------------------------------- |
| [E025 — Design and prove reloadable user plugins](e025-runtime-plugins.md)                    | Research       | Cross-repo | P2       | L    | [E026](e026-command-metadata.md), [E027](e027-extension-hooks.md), [E028](../docs/architecture/modal-input-findings.md) |
...
| [E028 — Prove modal editing through public extensions](../docs/architecture/modal-input-findings.md)         | Research       | Editor     | P2       | M    | [E026](e026-command-metadata.md), [E027](e027-extension-hooks.md)                                        |
...
| Plan                                                                        | Kind           | Owner    | Priority | Size | Needs |
| --------------------------------------------------------------------------- | -------------- | -------- | -------- | ---- | ----- |
| [E030 — Offer a flat file view under a chosen root](../../platform/PLAN.md) | Implementation | Platform | P2       | M    | —     |
...
| Research: SAB-backed SoA piece tree (LMDB-style shared snapshots)     | [E009](../../platform/plans/099-document-contributions.md), [E010](../docs/performance/sab-transport-2026-09-12.md), [E011](e011-packed-piece-tree.md), [E012](../docs/performance/sab-transport-2026-09-12.md), [E013](../docs/performance/sab-transport-2026-09-12.md), [E014](e014-parallel-search.md), [E057](e057-delete-sab-transport.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Cursor position navigation history (alt+left / alt+right)             | [E020](../docs/editing/jump-history.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| File explorer: flattened view                                         | [E030](../../platform/PLAN.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Stress-test the input/command substrate with a modal (vim) layer      | [E028](../docs/architecture/modal-input-findings.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Compact blank lines (display-time)                                    | [E052](e052-proportional-font-extents.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Workaround audit: ask the owner, do not model it                      | [E047](../docs/display/e047-point-queries.md), [E048](../docs/display/e048-minimap-document-space.md), [E049](../docs/architecture/e049-no-silent-misses.md), [E050](../docs/architecture/e050-host-obligations.md), [E051](../docs/display/e051-fast-path-equivalence.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Edit commands without a whole-document string                         | [E055](../docs/performance/e055-edit-commands-read-lines.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
