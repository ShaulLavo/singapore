...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Performance foundation      | [E006 reclamation](e006-tombstone-reclamation.md), with E003 startup, E007 copies and E008 find complete, using the [E001 harness](../examples/stress/README.md)                                                                                                   | E006 also uses the [E005 inspector](../docs/storage/piece-tree-inspection.md); E014 parallel search builds on E008.                                                                             |
...
| [E033 — Make full-document text reads an explicit boundary](e033-explicit-full-text-boundary.md)                    | Implementation | Editor | P1       | L    | [E007](../docs/performance/e007-consumer-copies.md), [E031](../docs/performance/e031-projection.md), [E032](../docs/performance/e032-edit-batches.md), [E034](../docs/performance/e034-snapshot-indentation-folds.md) |
