...
E036–E040 were added on 2026-09-14 and 2026-09-16, and E037 completed on 2026-09-16, so 9
completed entries retain permanent references and 31 execution plans remain.
...
| Textbuffer cost             | [E037 per-edit allocations](../docs/performance/e037-textbuffer-edit-allocations.md), which also makes the benchmark counters a gate                                                                                                                      | E038 buffer store and E040 balanced tree can run in parallel; E039 reverse index follows E038.                              |
...
E037 landed first and turned the structural counters into a CI gate; the three larger entries each
...
| [E038 — Append inserted text without copying the buffer store](e038-append-only-buffer-store.md)                            | Implementation | Editor | P1       | L    | [E037](../docs/performance/e037-textbuffer-edit-allocations.md)                                           |
| [E039 — Make reverse-index maintenance cheaper than the edit it follows](e039-reverse-index-cost.md)                        | Implementation | Editor | P2       | L    | [E037](../docs/performance/e037-textbuffer-edit-allocations.md), [E038](e038-append-only-buffer-store.md) |
